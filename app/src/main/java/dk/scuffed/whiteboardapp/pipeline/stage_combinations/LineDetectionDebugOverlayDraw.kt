...
internal fun lineDetectionDebugOverlayDraw(
    ...
    val drawLinesVert = DrawLinesStage(context, verticalLinesAngleDiscriminatorStage, Color(1f, 0f, 0f, 0.5f), pipeline)

    val drawLinesHor = DrawLinesStage(context, horizontalLinesAngleDiscriminatorStage, Color(0f, 1f, 0f, 0.5f), pipeline)


    val overlay1 = OverlayStage(context, inputStage.frameBufferInfo, drawLinesVert.frameBufferInfo, pipeline)
    val overlay2 = OverlayStage(context, overlay1.frameBufferInfo, drawLinesHor.frameBufferInfo, pipeline)
