...
internal class LinesAngleDiscriminatorStage(private val linesOutputStage: LinesOutputStage, private val minAngle: Float, private val maxAngle: Float, pipeline: IPipeline) : LinesOutputStage(pipeline) {
    override fun update() {
        lines.clear()
