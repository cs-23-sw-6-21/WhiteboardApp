...
internal class LinesAngleDiscriminatorStage(private val linesOutputStage: LinesOutputStage, private val minAngle: Float, private val maxAngle: Float, private val maxLines: Int, pipeline: Pipeline) : LinesOutputStage(pipeline) {
    override fun update() {
        lines.clear()
